    ...
    public:
        ...
        bool checaConsistencia() {
            ...
            for (auto &a : transicao)
            {
                ...
                if (std::find(std::begin(alfabetoMaquina), std::end(alfabetoMaquina), a.first.second)
                        == std::end(alfabetoMaquina))
                    return false;
                //! transicao (pra onde vai) contem apenas simolos do alfabeto ?
                if (std::find(std::begin(alfabetoMaquina), std::end(alfabetoMaquina), a.second.second) ==
                    std::end(alfabetoMaquina))
                        return false;
